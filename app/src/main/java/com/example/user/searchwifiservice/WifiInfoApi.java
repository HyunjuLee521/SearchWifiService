...
public interface WifiInfoApi {
    ...
    String BASE_URL = "https://openAPI.seoul.go.kr:8088/774f70747462736736326e426e7947/json/PublicWiFiPlaceInfo/";

    @GET("1/{END_INDEX}/{GU_NM}")
    Call<PublicWiFiPlaceInfo> getWifiInfoList (@Path("END_INDEX") String END_INDEX,
